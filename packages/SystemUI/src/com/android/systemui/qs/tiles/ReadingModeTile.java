...
public class ReadingModeTile extends QSTileImpl<BooleanState> {
    ...
    public ReadingModeTile(QSHost host) {
        ...
        mSetting = new SecureSetting(mContext, mHandler, Secure.ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED) {
            @Override
    ...
    //             .getBoolean(com.android.internal.R.bool.config_greyScaleSupport);
    // }
    ...
    public Intent getLongClickIntent() {
        return new Intent().setComponent(new ComponentName(
            "com.android.settings", "com.android.settings.Settings$AccessibilityDaltonizerSettingsActivity"));
    }

    @Override
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.accessibility_reading_mode);
    }
